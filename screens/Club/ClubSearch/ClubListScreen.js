...
const ClubListScreen = () => {
  ...
  const { activities, days } = route.params; // 다중 선택된 배열

  const clubs = [
    { id: 1, name: '골프 마스터', description: '주 1회 골프장 모임', activity: '골프장', day: '월' },
    { id: 2, name: '주말 게이트볼', description: '토요일 게이트볼 활동', activity: '게이트볼', day: '토' },
    { id: 3, name: '테니스 동호회 A', description: '수요일 테니스 레슨 포함', activity: '테니스', day: '수' },
    { id: 4, name: '수영 동호회 B', description: '금요일 자유 수영', activity: '수영장', day: '금' },
    { id: 5, name: '골프 & 테니스 혼합', description: '골프와 테니스 모임', activity: '골프장', day: '수' },
  ];
